...
const Transfer = () => {
  const { noTransfers, oneTransfer, twoTransfers, threeTransfers } =
  ...
  return (
    <div className={style.transferCard}>
      ...
      <label
        className={[
          style.checkBoxWrap,
          checkedAll && style.checkBoxActive,
        ].join(" ")}
      >
        <input
          className="hidden"
      ...
      <label
        className={[
          style.checkBoxWrap,
          noTransfers && style.checkBoxActive,
        ].join(" ")}
      >
        <input
          className="hidden"
      ...
      <label
        className={[
          style.checkBoxWrap,
          oneTransfer && style.checkBoxActive,
        ].join(" ")}
      >
        <input
          className="hidden"
      ...
      <label
        className={[
          style.checkBoxWrap,
          twoTransfers && style.checkBoxActive,
        ].join(" ")}
      >
        <input
          className="hidden"
      ...
      <label
        className={[
          style.checkBoxWrap,
          threeTransfers && style.checkBoxActive,
        ].join(" ")}
      >
        <input
          className="hidden"
